...
cf push -p ./ui-customer-service/target/ui-customer-service-0.0.1-SNAPSHOT.jar -f ./ui-customer-service/manifest.yml
cf push -p ./ui-staff-service/target/ui-staff-service-0.0.1-SNAPSHOT.jar -f ./ui-staff-service/manifest.ymlgit